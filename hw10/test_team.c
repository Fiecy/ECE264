...
struct Team create_test_team3() {
	struct Person people[] = {
	  { .name = "Anna"    ,.favorites = create_favorites(NULL)},
	  { .name = "Liangts" ,.favorites = create_favorites(NULL)},
	  { .name = "YL"      ,.favorites = create_favorites(NULL)},
	};
...
struct Team create_test_team() {
	struct Person people[] = {
	  { .name = "Anna"    , .favorites = create_favorites(&people[2], &people[0], NULL)},
	  { .name = "Liangts" , .favorites = create_favorites(&people[1], NULL)},
	  { .name = "YL"      , .favorites = create_favorites(&people[3], &people[2], &people[3], NULL)},
	  { .name = "Momo"    , .favorites = create_favorites(&people[3], &people[2], NULL)},
	};
...
int main(int argc, char *argv[]) {
	...
	add_favorite(find_person(&team, "YL"), find_person(&team, "XDDDLiangts"), 2);
