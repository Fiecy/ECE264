...
struct Team create_test_team() {
	struct Person people[] = {
	  { .name = "Anna"    , .favorites = create_favorites(&people[2], &people[2], &people[1], NULL)},
	  { .name = "Liangts" , .favorites = create_favorites(&people[1], NULL)},
	  { .name = "YL"      , .favorites = create_favorites(&people[1], &people[2], &people[1], NULL)},
	  { .name = "Momo"    , .favorites = create_favorites(&people[0], NULL)},
	};
